...
CLASS_NAME = {'donuts':1, 'cup_cakes':2, 'samosa':3, 'prime_rib':4, 'omelette':5, 'caesar_salad':6, 'macaroni_and_cheese':7, 'pizza':8, 'macarons':9, 'hot_dog':10 }
CLASS_ID = {1:'donuts', 2:'cup_cakes', 3:'samosa', 4:'prime_rib', 5:'omelette', 6:'caesar_salad', 7:'macaroni_and_cheese', 8:'pizza', 9:'macarons', 10:'hot_dog' }
############################################################
#  Configurations
############################################################
...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        for a in annotations:
            ...
            class_names_each_region = [r['region_attributes']['food'] if 'food' in r['region_attributes']
                                          else r['region_attributes']['category_id'] for r in a['regions']]
            
            #print("class-",class_names_each_region)
...
def train(model, epochs):
    ...
    #             epochs=100,
    #             layers='heads',
    #             augmentation=augmentation, custom_callbacks=[mean_average_precision_callback])
    # model.train(dataset_train, dataset_val,
    #             learning_rate=config.LEARNING_RATE,
    #             epochs=40,
    #             layers='heads',
    ...
    augmentation = imgaug.augmenters.Sometimes(0.3, [
                    imgaug.augmenters.Fliplr(0.5),
                    imgaug.augmenters.GaussianBlur(sigma=(0.0, 0.5)),
                    imgaug.augmenters.Affine(
                        scale={"x": (0.8, 1.2), "y": (0.8, 1.2)},
